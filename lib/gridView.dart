    ...
    return Scaffold(
      ...
      body: GridView(
        ...
        children: [
          ...
          postContainer(number: "4", colorData: Colors.red),
          postContainer(number: "5", colorData: Colors.amber),
          postContainer(number: "6", colorData: Colors.green),
          postContainer(number: "7", colorData: Colors.blue),
          postContainer(number: "8", colorData: Colors.red),
          postContainer(number: "9", colorData: Colors.amber),
          postContainer(number: "10", colorData: Colors.green),
          postContainer(number: "11", colorData: Colors.blue),
          postContainer(number: "12", colorData: Colors.red),
        ],
      ),
    );
  }
